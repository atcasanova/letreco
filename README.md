...
Analisando a aplicação do Letreco foi possível extrair toda a lista de palavras consideradas por eles, que é consideravelmente maior do que a utilizada anteriormente e contém centenas de palavras que sequer constam no [https://www.academia.org.br/nossa-lingua/busca-no-vocabulario](VOLP).
